  ...
  const fetchBookings = async (skipLoading = false, useCurrentFilter = false) => {
    try {
      ...
      if (bookingsList.length > 0) {
        console.log('[Admin] First booking structure:', JSON.stringify(bookingsList[0], null, 2));
      }
                          ...
                          {booking.service?.name ||
                            ...
                            (booking.services && booking.services.length > 0
                              ? booking.services
                                  ...
                                  .join(", ")
                              : (booking.services_names && booking.services_names.length > 0
                                ? booking.services_names.join(", ")
                                : "Стандартни сервис (30 мин)"))}
                        </td>
                        <td className="px-4 py-3 text-sm whitespace-nowrap">
                          {booking.date || "N/A"}
                        </td>
